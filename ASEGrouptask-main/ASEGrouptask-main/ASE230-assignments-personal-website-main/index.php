...
<?php
	...
	Function showCard ($count){
			...
			echo '<h1>$student[$count]['name']</h1>';
			echo '<p>$student[$count]['age'] </p>';
			echo '<p>$student[$count]['gender'] </p>';
			echo '<p>$student[$count]['year'] </p>';
			echo '<p>$student[$count]['pictures'] </p>';
...
for($i=0;$i<count($student);$i++){
	echo '<h1>$dogs[$_GET['$i']]['name'] </h1>';
	echo '<p>$dogs[$_GET['$i']]['age']</p>';
	echo '<p>$dogs[$_GET['$i']]['gender']</p>';
	echo '<p>$dogs[$_GET['$i']]['year']</p>';
	echo '<p>$dogs[$_GET['$i']]['pictures']</p>';
